...
const createSanityUser = async (relawan_iqbaldinda_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-relawan-iqbaldinda', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: relawan_iqbaldinda_userData.name,
              email: relawan_iqbaldinda_userData.email,
              password: relawan_iqbaldinda_userData.password,
              type: relawan_iqbaldinda_userData.type,
            },
          },
        ],
      }),
